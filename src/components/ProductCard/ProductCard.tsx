...
export function ProductCard({ product, badge, onAddToCart }: ProductCardProps) {
  return (
    <div className="bg-surface border border-border rounded-lg overflow-hidden flex flex-col w-72">
      <img
        src={product.image}
        alt={product.title}
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        <Button className="mt-auto w-full" onClick={() => onAddToCart?.(product)}>
          Add to cart
        </Button>
      </div>
    </div>
